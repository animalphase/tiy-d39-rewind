...
class Question extends React.Component {
  ...
  currentQuestion(questionId) {
    return this.props.questionsApp.questions.filter((current, i, array) => {
  ...
  handlePagination(direction, current, max) {
    if (direction === 'next' && current < max) {
      this.props.history.push('/questions/question/' + (Number(current) + 1));
        ...
        <main className="page-frame">
          ...
          <section className="page-content">
            ...
            <form>
              ...
              <button
                type="submit"
                onClick={e => this.handleSubmit(e, currentQuestionNumber)}
              >
                Submit
              </button>
            </form>
            <div className="pagination">
              ...
              <span className="pagination-count">
                {currentQuestionNumber} of {maxQuestionNumber}
              </span>
              <button
                type="button"
                onClick={() =>
